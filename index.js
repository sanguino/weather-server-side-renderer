...
fetch('https://api.openweathermap.org/data/2.5/weather?id=3118848&APPID=999f7d104881fc770d5a845d5c0ccfe7&units=metric').then(r => r.json() ).then(r => {
	console.log(r)
	console.log('r.weather[0].id', r.weather[0].id)
	console.log('r.main.temp', r.main.temp)
	console.log('r.main.feels_like', r.main.feels_like)
	console.log('r.main.temp_min', r.main.temp_min)
	console.log('r.main.temp_max', r.main.temp_max)
	console.log('r.main.humidity', r.main.humidity)
	console.log('r.wind.speed', r.wind.speed)
	console.log('r.wind.deg', r.wind.deg)
	console.log('r.sys.sunrise', r.sys.sunrise)
	console.log('r.sys.sunset', r.sys.sunset)
	console.log('r.dt', r.dt)
...
//     console.log(list[0])
//     document.querySelector('.icon').innerHTML = `<i class="${getIcon(list[0], r.dt, r.sys.sunrise, r.sys.sunset)}"></i>`
//     document.querySelector('.temp').innerHTML = `${formatNum(44.4, 'º', 'bigger', 'big')}`
//   });
});
